...
import subprocess
app = Flask(__name__)
with open('C:/Users/Pratham/Downloads/zacson-master (1)/zacson-master/diet-recommendation-system-main/food_model.pickle', 'rb') as file:
    model = pickle.load(file)
food_data = pd.read_csv('C:/Users/Pratham/Downloads/zacson-master (1)/zacson-master/diet-recommendation-system-main/done_food_data.csv')
...
def search(sort_by='Descrip'):
    ...
    iron = request.form.getlist('iron')
    calcium = request.form.getlist('calcium')
    rows = read_csv('C:/Users/Pratham/Downloads/zacson-master (1)/zacson-master/diet-recommendation-system-main/done_food_data.csv', sort_by)
    return render_template('search.html', rows=rows)
@app.route('/execute/<pose>')
def execute_pose(pose):
    try:
        subprocess.call(['python', f'C:/Users/Pratham/Downloads/zacson-master (1)/zacson-master/new python/{pose}.py'])
        return f'Successfully executed{pose}.py'
    except Exception as e:
        return f'Error executing{pose}.py: {str(e)}'
